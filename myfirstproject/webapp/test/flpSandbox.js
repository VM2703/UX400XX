		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My first UI5 project",
									"targetURL": "#trainingsapmyfirstproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainingsapmyfirstproject-display": {
								"semanticObject": "trainingsapmyfirstproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=training.sap.myfirstproject",
									"url": sap.ui.require.toUrl("training/sap/myfirstproject")
								}
							}
						}
					}
