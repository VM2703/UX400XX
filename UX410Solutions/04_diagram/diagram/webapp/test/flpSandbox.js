		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Main",
									"targetURL": "#saptrainingdiagram-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingdiagram-display": {
								"semanticObject": "saptrainingdiagram",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.diagram",
									"url": sap.ui.require.toUrl("sap/training/diagram")
								}
							}
						}
					}
