		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Value help",
									"targetURL": "#student00saptrainingvaluehelp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingvaluehelp-display": {
								"semanticObject": "student00saptrainingvaluehelp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.valuehelp",
									"url": sap.ui.require.toUrl("student00/sap/training/valuehelp")
								}
							}
						}
					}
