		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 navigation starter 00",
									"targetURL": "#saptrainingstartnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingstartnavigation-display": {
								"semanticObject": "saptrainingstartnavigation",
								"action": "display",
								"description": "UX410 navigation starter 00.",
								"title": "UX410 navigation starter 00",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.startnavigation",
									"url": sap.ui.require.toUrl("sap/training/startnavigation")
								}
							}
						}
					}
