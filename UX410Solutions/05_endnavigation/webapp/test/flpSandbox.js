		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 navigation end 00",
									"targetURL": "#saptrainingendnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingendnavigation-display": {
								"semanticObject": "saptrainingendnavigation",
								"action": "display",
								"description": "UX410 navigation end 00.",
								"title": "UX410 navigation end 00",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.endnavigation",
									"url": sap.ui.require.toUrl("sap/training/endnavigation")
								}
							}
						}
					}
