		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 helloworld 00",
									"targetURL": "#saptraininghelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptraininghelloworld-display": {
								"semanticObject": "saptraininghelloworld",
								"action": "display",
								"description": "UX410 helloworld 00.",
								"title": "UX410 helloworld 00",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.helloworld",
									"url": sap.ui.require.toUrl("sap/training/helloworld")
								}
							}
						}
					}
