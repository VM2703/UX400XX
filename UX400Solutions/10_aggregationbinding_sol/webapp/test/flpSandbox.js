		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingaggregationbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingaggregationbinding-display": {
								"semanticObject": "saptrainingaggregationbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.aggregationbinding",
									"url": sap.ui.require.toUrl("sap/training/aggregationbinding")
								}
							}
						}
					}
