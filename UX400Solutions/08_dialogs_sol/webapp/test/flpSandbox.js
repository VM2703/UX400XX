		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dialogs",
									"targetURL": "#saptrainingdialogs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingdialogs-display": {
								"semanticObject": "saptrainingdialogs",
								"action": "display",
								"description": "Create and Use a Dialog",
								"title": "Dialogs",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.dialogs",
									"url": sap.ui.require.toUrl("sap/training/dialogs")
								}
							}
						}
					}
