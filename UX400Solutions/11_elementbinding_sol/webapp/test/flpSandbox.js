		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingelementbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingelementbinding-display": {
								"semanticObject": "saptrainingelementbinding",
								"action": "display",
								"description": "Use Element Binding",
								"title": "Element Binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.elementbinding",
									"url": sap.ui.require.toUrl("sap/training/elementbinding")
								}
							}
						}
					}
