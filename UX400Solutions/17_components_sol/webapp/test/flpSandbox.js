		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingcomponents-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingcomponents-display": {
								"semanticObject": "saptrainingcomponents",
								"action": "display",
								"description": "Create an SAPUI5 Component",
								"title": "SAPUI5 Component",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.components",
									"url": sap.ui.require.toUrl("sap/training/components")
								}
							}
						}
					}
