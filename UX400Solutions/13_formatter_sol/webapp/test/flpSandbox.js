		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formatter Functions, Sorting, and Calculated Fields",
									"targetURL": "#saptrainingformatter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingformatter-display": {
								"semanticObject": "saptrainingformatter",
								"action": "display",
								"description": "Work with Formatter Functions, Sorting, and Calculated Fields",
								"title": "Formatter Functions, Sorting, and Calculated Fields",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.formatter",
									"url": sap.ui.require.toUrl("sap/training/formatter")
								}
							}
						}
					}
