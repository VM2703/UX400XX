		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptraininglayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptraininglayout-display": {
								"semanticObject": "saptraininglayout",
								"action": "display",
								"description": "Work with Layout Controls",
								"title": "Layout Controls",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.layout",
									"url": sap.ui.require.toUrl("sap/training/layout")
								}
							}
						}
					}
