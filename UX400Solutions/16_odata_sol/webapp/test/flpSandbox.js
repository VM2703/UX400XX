		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Model",
									"targetURL": "#saptrainingodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingodata-display": {
								"semanticObject": "saptrainingodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.odata",
									"url": sap.ui.require.toUrl("sap/training/odata")
								}
							}
						}
					}
