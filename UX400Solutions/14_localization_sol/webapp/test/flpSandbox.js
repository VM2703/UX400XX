		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Localization",
									"targetURL": "#saptraininglocalization-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptraininglocalization-display": {
								"semanticObject": "saptraininglocalization",
								"action": "display",
								"description": "Incorporate Localization in a SAPUI5 Application",
								"title": "Localization",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.localization",
									"url": sap.ui.require.toUrl("sap/training/localization")
								}
							}
						}
					}
