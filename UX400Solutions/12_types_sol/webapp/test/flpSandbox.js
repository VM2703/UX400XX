		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Types and Input Validation",
									"targetURL": "#saptrainingtypes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingtypes-display": {
								"semanticObject": "saptrainingtypes",
								"action": "display",
								"description": "Use Data Types and Input Validation",
								"title": "Data Types and Input Validation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.types",
									"url": sap.ui.require.toUrl("sap/training/types")
								}
							}
						}
					}
