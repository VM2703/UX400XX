		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingpropertybinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingpropertybinding-display": {
								"semanticObject": "saptrainingpropertybinding",
								"action": "display",
								"description": "Use Property Binding",
								"title": "Property Binding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.propertybinding",
									"url": sap.ui.require.toUrl("sap/training/propertybinding")
								}
							}
						}
					}
